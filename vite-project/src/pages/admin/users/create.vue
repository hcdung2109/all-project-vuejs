            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="role_id" id="role_id">
                  ...
                  <option v-for="(role,index) in roles" value="">{{ role.name }}</option>
                </select>
              </div>
...
export default {
  ...
  setup() {
    ...
    const submitForm = () => {
      axios.post(API_URL + "api/user/", users, options)
            .then((response) => {
    ...
    return { roles, submitForm, ...toRefs(users), errors };
  },
};
</script>
